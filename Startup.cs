    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDistributedRedisCache(options =>
            {
                ...
                services.AddScoped<CountryMasterService, CountryMasterService>();
            services.AddScoped<CountryMasterRepository, CountryMasterRepository>();
